...
class ShotGenDecoder(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_local_output, encode_global_A,
                encode_global_B, trg_mask=None, return_attns=False):
...
class ShotGenDecoder2(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        for i in range(0, self.config['n_layers']):
            decode_output_area_A, decode_output_shot_A, dec_slf_attn_A, dec_enc_attn_A, disentangled_weight_A = self.global_layer_A(
                decode_output_area_A, decode_output_shot_A, encode_global_area_A, encode_global_shot_A,
                slf_attn_mask=trg_global_A_mask, return_attns=return_attns)
            if decode_output_area_B.shape[1] != 0:
                decode_output_area_B, decode_output_shot_B, dec_slf_attn_B, dec_enc_attn_B, disentangled_weight_B = self.global_layer_B(
                    decode_output_area_B, decode_output_shot_B, encode_global_area_B, encode_global_shot_B,
                    slf_attn_mask=trg_global_B_mask, return_attns=return_attns)

            decode_output_area, decode_output_shot, dec_slf_attn, dec_enc_attn, disentangled_weight_local = self.local_layer(
                decode_output_area, decode_output_shot, encode_local_output_area, encode_local_output_shot,
                slf_attn_mask=trg_local_mask, return_attns=return_attns)

        decoder_self_attention_list = dec_slf_attn if return_attns else []
        decoder_encoder_self_attention_list = dec_enc_attn if return_attns else []

        if decode_output_area_B.shape[1] != 0:
            decode_output_A_area = alternatemerge(decode_output_area_A, decode_output_area_A,
                                                  decode_output_area.shape[1], 'A')
            decode_output_A_shot = alternatemerge(decode_output_shot_A, decode_output_shot_A,
                                                  decode_output_shot.shape[1], 'A')
            decode_output_B_area = alternatemerge(decode_output_area_B, decode_output_area_B,
                                                  decode_output_area.shape[1], 'B')
            decode_output_B_shot = alternatemerge(decode_output_shot_B, decode_output_shot_B,
                                                  decode_output_shot.shape[1], 'B')
        else:
        ...
        decode_output = self.gated_fusion(decode_output_A_area, decode_output_B_area, decode_output_area,
                                          decode_output_A_shot, decode_output_B_shot, decode_output_shot)
...
class ShotGenDecoder_model3_small(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_aroundhead, input_backhand,
        ...
        decode_output_area, decode_output_shot = self.gated_fusion(decode_output_A_area, decode_output_B_area,
                                                                   decode_output_area, decode_output_A_shot,
                                                                   decode_output_B_shot, decode_output_shot)
...
class ShotGenDecoder_Big(nn.Module):
    def __init__(self, config):
        ...
        self.gated_fusion = GatedFusionLayer_Big(d_model, d_model, config['encode_length'],
                                                 config['max_ball_round'] + 1)

    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
                encode_output_pan, encode_output_oan, encode_output_area_A, encode_output_shot_A, encode_output_bh_A,
                encode_output_ba_A, encode_output_bb_A, encode_output_pan_A, encode_output_oan_A, encode_output_area_B,
                encode_output_shot_B, encode_output_bh_B, encode_output_ba_B, encode_output_bb_B, encode_output_pan_B,
                encode_output_oan_B,
                trg_mask=None, return_attns=False):
        ...
        for i in range(0, self.config['n_layers']):
            decode_output_area_A, decode_output_shot_A, decode_output_bh_A, decode_output_ba_A, decode_output_bb_A, decode_output_pan_A, decode_output_oan_A, dec_slf_attn_A, dec_enc_attn_A, disentangled_weight_A = self.global_layer_A(
                decode_output_area_A, decode_output_shot_A, decode_output_bh_A, decode_output_ba_A, decode_output_bb_A,
                decode_output_pan_A, decode_output_oan_A,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
                encode_output_pan_A, encode_output_oan_A, slf_attn_mask=trg_global_A_mask, return_attns=return_attns)
            if decode_output_area_B.shape[1] != 0:
                decode_output_area_B, decode_output_shot_B, decode_output_bh_B, decode_output_ba_B, decode_output_bb_B, decode_output_pan_B, decode_output_oan_B, dec_slf_attn_B, dec_enc_attn_B, disentangled_weight_B = self.global_layer_B(
                    decode_output_area_B, decode_output_shot_B, decode_output_bh_B, decode_output_ba_B,
                    decode_output_bb_B, decode_output_pan_B, decode_output_oan_B,
                    encode_output_area_B, encode_output_shot_B, encode_output_bh_B, encode_output_ba_B,
                    encode_output_bb_B, encode_output_pan_B, encode_output_oan_B, slf_attn_mask=trg_global_B_mask,
                    return_attns=return_attns)
            ...
            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, dec_slf_attn, dec_enc_attn, disentangled_weight_local = self.local_layer(
                decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb,
                decode_output_pan, decode_output_oan,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
                encode_output_pan, encode_output_oan, slf_attn_mask=trg_local_mask, return_attns=return_attns)
        ...
        if decode_output_area_B.shape[1] != 0:
            ...
            decode_output_A_pan = alternatemerge(decode_output_pan_A, decode_output_pan_A, decode_output_pan.shape[1],
                                                 'A')
            decode_output_A_oan = alternatemerge(decode_output_oan_A, decode_output_oan_A, decode_output_oan.shape[1],
                                                 'A')
            decode_output_B_area = alternatemerge(decode_output_area_B, decode_output_area_B,
                                                  decode_output_area.shape[1], 'B')
            decode_output_B_shot = alternatemerge(decode_output_shot_B, decode_output_shot_B,
            ...
            decode_output_B_pan = alternatemerge(decode_output_pan_B, decode_output_pan_B, decode_output_pan.shape[1],
                                                 'B')
            decode_output_B_oan = alternatemerge(decode_output_oan_B, decode_output_oan_B, decode_output_oan.shape[1],
                                                 'B')
        else:
            decode_output_A_area = decode_output_area_A.clone()
            decode_output_A_shot = decode_output_shot_A.clone()
        ...
        decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan = self.gated_fusion(
            decode_output_A_area, decode_output_B_area, decode_output_area, decode_output_A_shot, decode_output_B_shot,
            decode_output_shot,
            decode_output_A_bh, decode_output_B_bh, decode_output_bh, decode_output_A_ba, decode_output_B_ba,
            decode_output_ba,
            decode_output_A_bb, decode_output_B_bb, decode_output_bb, decode_output_A_pan, decode_output_B_pan,
            decode_output_pan,
...
class ShotGenDecoder_Big2(nn.Module):
    def __init__(self, config):
        ...
        self.gated_fusion = GatedFusionLayer_Big2(d_model, d_model, config['encode_length'],
                                                  config['max_ball_round'] + 1)

    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, input_player_location_x,
                input_player_location_y, input_opponent_location_x, input_opponent_location_y,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
                encode_output_pan, encode_output_oan, encode_output_pl, encode_output_ol,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
                encode_output_pan_A, encode_output_oan_A, encode_output_pl_A, encode_output_ol_A,
                encode_output_area_B, encode_output_shot_B, encode_output_bh_B, encode_output_ba_B, encode_output_bb_B,
                encode_output_pan_B, encode_output_oan_B, encode_output_pl_B, encode_output_ol_B,
                trg_mask=None, return_attns=False):
        ...
        ol = torch.cat((input_opponent_location_x.unsqueeze(-1), input_opponent_location_y.unsqueeze(-1)),
                       dim=-1).float()
        ...
        for i in range(0, self.config['n_layers']):
            decode_output_area_A, decode_output_shot_A, decode_output_bh_A, decode_output_ba_A, decode_output_bb_A, decode_output_pan_A, decode_output_oan_A, decode_output_pl_A, decode_output_ol_A, dec_slf_attn_A, dec_enc_attn_A, disentangled_weight_A = self.global_layer_A(
                decode_output_area_A, decode_output_shot_A, decode_output_bh_A, decode_output_ba_A, decode_output_bb_A,
                decode_output_pan_A, decode_output_oan_A, decode_output_pl_A, decode_output_ol_A,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
                encode_output_pan_A, encode_output_oan_A, encode_output_pl_A, encode_output_ol_A,
                slf_attn_mask=trg_global_A_mask, return_attns=return_attns)
            if decode_output_area_B.shape[1] != 0:
                decode_output_area_B, decode_output_shot_B, decode_output_bh_B, decode_output_ba_B, decode_output_bb_B, decode_output_pan_B, decode_output_oan_B, decode_output_pl_B, decode_output_ol_B, dec_slf_attn_B, dec_enc_attn_B, disentangled_weight_B = self.global_layer_B(
                    decode_output_area_B, decode_output_shot_B, decode_output_bh_B, decode_output_ba_B,
                    decode_output_bb_B, decode_output_pan_B, decode_output_oan_B, decode_output_pl_B,
                    decode_output_ol_B,
                    encode_output_area_B, encode_output_shot_B, encode_output_bh_B, encode_output_ba_B,
                    encode_output_bb_B, encode_output_pan_B, encode_output_oan_B, encode_output_pl_B,
                    encode_output_ol_B, slf_attn_mask=trg_global_B_mask, return_attns=return_attns)
                # decode_output_area_B, decode_output_shot_B, dec_slf_attn_B, dec_enc_attn_B, disentangled_weight_B = self.global_layer_B(decode_output_area_B, decode_output_shot_B, encode_global_area_B, encode_global_shot_B, slf_attn_mask=trg_global_B_mask, return_attns=return_attns)

            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, decode_output_pl, decode_output_ol, dec_slf_attn, dec_enc_attn, disentangled_weight_local = self.local_layer(
                decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb,
                decode_output_pan, decode_output_oan, decode_output_pl, decode_output_ol,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
                encode_output_pan, encode_output_oan, encode_output_pl, encode_output_ol, slf_attn_mask=trg_local_mask,
                return_attns=return_attns)
            # decode_output_area, decode_output_shot, dec_slf_attn, dec_enc_attn, disentangled_weight_local = self.local_layer(decode_output_area, decode_output_shot, encode_local_output_area, encode_local_output_shot, slf_attn_mask=trg_local_mask, return_attns=return_attns)
        ...
        decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, decode_output_pl, decode_output_ol = self.gated_fusion(
            decode_output_A_area, decode_output_B_area, decode_output_area, decode_output_A_shot, decode_output_B_shot,
            decode_output_shot,
            decode_output_A_bh, decode_output_B_bh, decode_output_bh, decode_output_A_ba, decode_output_B_ba,
            decode_output_ba,
            decode_output_A_bb, decode_output_B_bb, decode_output_bb, decode_output_A_pan, decode_output_B_pan,
            decode_output_pan,
            decode_output_A_oan, decode_output_B_oan, decode_output_oan, decode_output_A_pl, decode_output_B_pl,
            decode_output_pl,
...
class ShotGenPredictor(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_local_output, encode_global_A,
                encode_global_B, target_player, return_attns=False):
        ...
        if return_attns:
            decode_output, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_local_output, encode_global_A,
                encode_global_B, return_attns=return_attns)
        else:
            decode_output = self.shotgen_decoder(input_shot, input_x, input_y, input_player, input_height,
                                                 input_aroundhead, input_backhand,
                                                 input_player_location_area, input_opponent_location_area,
                                                 encode_local_output, encode_global_A, encode_global_B, return_attns)
...
class ShotGenPredictor2(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_local_output_area,
                encode_local_output_shot,
                encode_global_area_A, encode_global_shot_A, encode_global_area_B, encode_global_shot_B, target_player,
                return_attns=False):
        ...
        if return_attns:
            decode_output, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                ...
                input_player_location_area, input_opponent_location_area, encode_local_output_area,
                encode_local_output_shot,
                encode_global_area_A, encode_global_shot_A, encode_global_area_B, encode_global_shot_B,
                return_attns=return_attns)
        else:
            decode_output = self.shotgen_decoder(input_shot, input_x, input_y, input_player, input_height,
                                                 input_aroundhead, input_backhand,
                                                 input_player_location_area, input_opponent_location_area,
                                                 encode_local_output_area, encode_local_output_shot,
                                                 encode_global_area_A, encode_global_shot_A, encode_global_area_B,
                                                 encode_global_shot_B, return_attns=return_attns)
...
class ShotGenPredictor_model_hybrid(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        decode_output_area, decode_output_shot = self.shotgen_decoder_shot(input_shot, input_x, input_y, input_player,
                                                                           input_height, input_aroundhead,
                                                                           input_backhand,
                                                                           input_player_location_area,
                                                                           input_opponent_location_area,
                                                                           encoder_result['shot'][0],
                                                                           encoder_result['shot'][1],
                                                                           encoder_result['shot'][2],
                                                                           encoder_result['shot'][3],
                                                                           encoder_result['shot'][4],
                                                                           encoder_result['shot'][5],
                                                                           return_attns=return_attns)
...
class ShotGenPredictor_model3_small(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_aroundhead, input_backhand,
        ...
        embedded_target_player = self.player_embedding(target_player)
        if return_attns:
            decode_output_area, decode_output_shot, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_aroundhead, input_backhand, encode_local_output_area,
                encode_local_output_shot,
                encode_global_area_A, encode_global_shot_A, encode_global_area_B, encode_global_shot_B,
                return_attns=return_attns)
        else:
            decode_output_area, decode_output_shot = self.shotgen_decoder(input_shot, input_x, input_y, input_player,
                                                                          input_aroundhead, input_backhand,
                                                                          encode_local_output_area,
                                                                          encode_local_output_shot,
                                                                          encode_global_area_A, encode_global_shot_A,
                                                                          encode_global_area_B, encode_global_shot_B,
                                                                          return_attns=return_attns)
...
class ShotGenPredictorSimple(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, encode_local_output_area, encode_local_output_shot,
        ...
        if return_attns:
            decode_output_area, decode_output_shot, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, encode_local_output_area, encode_local_output_shot,
                encode_global_area_A, encode_global_shot_A, encode_global_area_B, encode_global_shot_B,
                return_attns=return_attns)
        else:
            decode_output_area, decode_output_shot = self.shotgen_decoder(input_shot, input_x, input_y, input_player,
...
class ShotGenPredictor_Big(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_output_area, encode_output_shot,
                encode_output_bh, encode_output_ba, encode_output_bb, encode_output_pan, encode_output_oan,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
                encode_output_pan_A, encode_output_oan_A, encode_output_area_B, encode_output_shot_B,
                encode_output_bh_B, encode_output_ba_B, encode_output_bb_B, encode_output_pan_B, encode_output_oan_B,
                target_player, return_attns=False):

        embedded_target_player = self.player_embedding(target_player)
        if return_attns:
            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_output_area, encode_output_shot,
                encode_output_bh, encode_output_ba, encode_output_bb, encode_output_pan, encode_output_oan,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
            ...
            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, encode_output_area, encode_output_shot,
                encode_output_bh, encode_output_ba, encode_output_bb, encode_output_pan, encode_output_oan,
                encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A,
...
class ShotGenPredictor_Big2(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        embedded_target_player = self.player_embedding(target_player)
        if return_attns:
            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, decode_output_pl, decode_output_ol, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, input_player_location_x,
                input_player_location_y, input_opponent_location_x, input_opponent_location_y,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
            ...
            decode_output_area, decode_output_shot, decode_output_bh, decode_output_ba, decode_output_bb, decode_output_pan, decode_output_oan, decode_output_pl, decode_output_ol = self.shotgen_decoder(
                input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, input_player_location_x,
                input_player_location_y, input_opponent_location_x, input_opponent_location_y,
                encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb,
...
class ShotGenPredictor_Big3(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        decode_output_oan = (decode_output_oan + embedded_target_player)
        decode_output = (
                    decode_output_area + decode_output_shot + decode_output_bh + decode_output_ba + decode_output_bb + decode_output_pan + decode_output_oan + embedded_target_player)
...
class ShotGenEncoder_hybrid(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                input_player_location_area, input_opponent_location_area, src_mask=None, return_attns=False):
        encode_local_output, encode_global_A, encode_global_B = self.encoder_area(self, input_shot, input_x, input_y,
                                                                                  input_player, input_height,
                                                                                  input_aroundhead, input_backhand,
                                                                                  input_player_location_area,
                                                                                  input_opponent_location_area,
                                                                                  src_mask, return_attns)
        encode_output_area, encode_output_shot, encode_output_area_A, encode_output_shot_A, encode_output_area_B, encode_output_shot_B = self.encoder_shot(
            self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        result = {
            ...
            'shot': (
            encode_output_area, encode_output_shot, encode_output_area_A, encode_output_shot_A, encode_output_area_B,
            encode_output_shot_B)
        }
        return result
...
class ShotGenEncoder_model3_small(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_aroundhead, input_backhand, src_mask=None,
                return_attns=False):
        ...
        for i in range(0, self.config['n_layers']):
            encode_output_area_A, encode_output_shot_A, enc_slf_attn_A = self.global_layer_A(encode_output_area_A,
                                                                                             encode_output_shot_A,
                                                                                             slf_attn_mask=src_mask)
            encode_output_area_B, encode_output_shot_B, enc_slf_attn_B = self.global_layer_B(encode_output_area_B,
                                                                                             encode_output_shot_B,
                                                                                             slf_attn_mask=src_mask)
            encode_output_area, encode_output_shot, enc_slf_attn = self.local_layer(encode_output_area,
                                                                                    encode_output_shot,
                                                                                    slf_attn_mask=src_mask)
...
class ShotGenEncoder_Big(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        for i in range(0, self.config['n_layers']):
            encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A, encode_output_pan_A, encode_output_oan_A, enc_slf_attn_A = self.global_layer_A(
                encode_output_area_A, encode_output_shot_A,
                encode_output_bh_A, encode_output_ba_A,
                encode_output_bb_A, encode_output_pan_A,
                encode_output_oan_A, slf_attn_mask=src_mask)
            encode_output_area_B, encode_output_shot_B, encode_output_bh_B, encode_output_ba_B, encode_output_bb_B, encode_output_pan_B, encode_output_oan_B, enc_slf_attn_B = self.global_layer_B(
                encode_output_area_B, encode_output_shot_B,
            ...
            encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb, encode_output_pan, encode_output_oan, enc_slf_attn = self.local_layer(
                encode_output_area, encode_output_shot,
...
class ShotGenEncoder_Big2(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
                ...
                src_mask=None, return_attns=False):

        enc_slf_attn_list = []

        area = torch.cat((input_x.unsqueeze(-1), input_y.unsqueeze(-1)), dim=-1).float()
        embedded_area = F.relu(self.area_embedding(area))
        area_pl = torch.cat((input_player_location_x.unsqueeze(-1), input_player_location_y.unsqueeze(-1)),
                            dim=-1).float()
        embedded_area_pl = F.relu(self.area_pl_embedding(area_pl))
        area_ol = torch.cat((input_opponent_location_x.unsqueeze(-1), input_opponent_location_y.unsqueeze(-1)),
                            dim=-1).float()
        ...
        for i in range(0, self.config['n_layers']):
            encode_output_area_A, encode_output_shot_A, encode_output_bh_A, encode_output_ba_A, encode_output_bb_A, encode_output_pan_A, encode_output_oan_A, encode_output_pl_A, encode_output_ol_A, enc_slf_attn_A = self.global_layer_A(
                encode_output_area_A, encode_output_shot_A,
                encode_output_bh_A, encode_output_ba_A,
                encode_output_bb_A, encode_output_pan_A,
                encode_output_oan_A, encode_output_pl_A, encode_output_ol_A, slf_attn_mask=src_mask)
            encode_output_area_B, encode_output_shot_B, encode_output_bh_B, encode_output_ba_B, encode_output_bb_B, encode_output_pan_B, encode_output_oan_B, encode_output_pl_B, encode_output_ol_B, enc_slf_attn_B = self.global_layer_B(
                encode_output_area_B, encode_output_shot_B,
                encode_output_bh_B, encode_output_ba_B,
                encode_output_bb_B, encode_output_pan_B,
            ...
            # encode_output_area_B, encode_output_shot_B, enc_slf_attn_B = self.global_layer_B(encode_output_area_B, encode_output_shot_B, slf_attn_mask=src_mask)
            # encode_output_area, encode_output_shot, enc_slf_attn = self.local_layer(encode_output_area, encode_output_shot, slf_attn_mask=src_mask)
            encode_output_area, encode_output_shot, encode_output_bh, encode_output_ba, encode_output_bb, encode_output_pan, encode_output_oan, encode_output_pl, encode_output_ol, enc_slf_attn = self.local_layer(
                encode_output_area, encode_output_shot,
                encode_output_bh, encode_output_ba,
                encode_output_bb, encode_output_pan,
...
class ShotGenDecoder_model3_ver3(nn.Module):
    def __init__(self, config):
        ...
        self.gated_fusion = GatedFusionLayer_model3_ver3(d_model, d_model, config['encode_length'],
                                                         config['max_ball_round'] + 1)
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_height, input_aroundhead, input_backhand,
        ...
        for i in range(0, self.config['n_layers']):
            decode_output_area_A, decode_output_shot_A, dec_slf_attn_A, dec_enc_attn_A, disentangled_weight_A = self.global_layer(
                decode_output_area_A, decode_output_shot_A, encode_global_area_A, encode_global_shot_A,
                slf_attn_mask=trg_global_A_mask, return_attns=return_attns)
            if decode_output_area_B.shape[1] != 0:
                decode_output_area_B, decode_output_shot_B, dec_slf_attn_B, dec_enc_attn_B, disentangled_weight_B = self.global_layer(
                    decode_output_area_B, decode_output_shot_B, encode_global_area_B, encode_global_shot_B,
                    slf_attn_mask=trg_global_B_mask, return_attns=return_attns)

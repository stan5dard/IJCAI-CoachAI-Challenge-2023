...
class BoolEmbedding(nn.Embedding):
    def __init__(self, bool_num, embed_dim):
        super(BoolEmbedding, self).__init__(bool_num, embed_dim, padding_idx=PAD)

class AreaEmbedding(nn.Embedding):
    def __init__(self, area_num, embed_dim):
        super(AreaEmbedding, self).__init__(area_num, embed_dim, padding_idx=PAD)
...
def generate(model_path, fold=None):
    ...
    # load model
    from MuLMINet.MuLMINet import ShotGenEncoder_MuLMINet_Variant1, ShotGenPredictor_MuLMINet_Variant1, ShotGenEncoder_MuLMINet_Variant2, ShotGenPredictor_MuLMINet_Variant2
    ...
    for rally_id in tqdm(testing_rallies):
        ...
        # feed into the model
        generated_shot, generated_area = shotgen_generator_MuLMINet(given_seq=given_seq, encoder=encoder, decoder=decoder, config=config, samples=SAMPLES, device=device)
